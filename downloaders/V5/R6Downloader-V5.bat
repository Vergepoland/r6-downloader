...
if errorlevel 1 (
  start https://builds.dotnet.microsoft.com/dotnet/Sdk/9.0.300/dotnet-sdk-9.0.300-win-x64.exe
  cls
  echo -----------------------------------------------------------------------------
...
MODE 81,18
echo --------------------------------------------------------------------------
echo ^|      OG Rainbow Six Siege Downloader (V5.0) - Made by Verge Poland     ^|
echo --------------------------------------------------------------------------
...
echo -------------------------------------------------------------------------- 
echo.
Resources\cmdMenuSel f870 "  Game Downloader" "  Test Server Downloader" "  4K Textures Download" "  Modding / Extra Tools" "  Downloader Settings" "  Installation Guide and FAQ"
...
echo.
Resources\cmdMenuSel f870 "  <- Back to Main Menu" "  Refresh Menu" "  Vanilla          | Y1S0 | 14.2 GB" "  Black Ice        | Y1S1 | 16.7 GB" "  Dust Line        | Y1S2 | 20.9 GB" "  Skull Rain       | Y1S3 | 25.1 GB" "  Red Crow         | Y1S4 | 28.5 GB" "  Velvet Shell     | Y2S1 | 33.2 GB" "  Health           | Y2S2 | 34.0 GB" "  Blood Orchid     | Y2S3 | 34.3 GB" "  White Noise      | Y2S4 | 48.7 GB" "  Chimera          | Y3S1 | 58.8 GB | (Outbreak)" "  Para Bellum      | Y3S2 | 63.3 GB" "  Grim Sky         | Y3S3 | 72.6 GB | (Mad House) " "  Wind Bastion     | Y3S4 | 76.9 GB" "  Burnt Horizon    | Y4S1 | 59.7 GB | (Rainbow Is Magic)" "  Phantom Sight    | Y4S2 | 67.1 GB | (Showdown)" "  Ember Rise       | Y4S3 | 69.6 GB | (Doktor's Curse/Money Heist)" "  Shifting Tides   | Y4S4 | 75.2 GB | (Stadium) " "  Void Edge        | Y5S1 | 74.3 GB | (The Grand Larceny/Golden Gun)" "  Steel Wave       | Y5S2 | 81.3 GB | (M.U.T.E. Protocol)" "  Shadow Legacy    | Y5S3 | 88.0 GB | (Sugar Fright)" "  Neon Dawn        | Y5S4 | xx.x GB | SUPPORTS HEATED METAL" "  Neon Dawn        | Y5S4 | xx.x GB | (Road To S.I. 2021)" "  Crimson Heist    | Y6S1 | xx.x GB | (Rainbow Is Magic 2 + Apocalypse)" "  North Star       | Y6S2 | xx.x GB | (Nest Destruction)" "  Crystal Guard    | Y6S3 | xx.x GB | (Showdown)" "  High Calibre     | Y6S4 | xx.x GB | (Stadium+Snowball)" "  Demon Veil       | Y7S1 | xx.x GB | (TOKY)" "  Vector Glare     | Y7S2 | xx.x GB | (Mute Reboot)" "  Brutal Swarm     | Y7S3 | xx.x GB | (Doctors Sniper)" "  Solar Raid       | Y7S4 | xx.x GB | (Snow Brawl)" "  Commanding Force | Y8S1 | xx.x GB | (RIM + TOKY)" "  Dread Factor     | Y8S2 | xx.x GB | (Rengoku V2)" "  Heavy Mettle     | Y8S3 | xx.x GB | (Doktor's Curse) NO OPERATORS" "  Deep Freeze      | Y8S4 | 52.9 GB | NO OPERATORS" "  Deadly Omen      | Y9S1 | xx.x GB | NO OPERATORS" "  New Blood        | Y9S2 | xx.x GB | NO OPERATORS" "  Twin Shells      | Y9S3 | 59.2 GB | NO OPERATORS" "  Collision Point  | Y9S4 | 59.2 GB | NO OPERATORS" "  Prep Phase       | Y10S1| 51.4 GB | NO OPERATORS"
echo.
if %ERRORLEVEL% == 1 goto mainmenu
...
cls
set /p username="Enter Steam Username:"
echo Heated Metal will NO longer be supported on Shadow Legacy! Use the Neon Dawn option to use future Heated Metal versions.
...
echo Launch the game using the RainbowSix.bat file instead of the RainbowSix.exe^!
pause
dotnet Resources\DepotDownloader.dll -app 359550 -depot 377237 -manifest 3390446325154338855 -username %username% %usecommand% -remember-password -dir "Downloads\Y5S4_NeonDawnHM" -validate -max-downloads %maxdownloads% -V
dotnet Resources\DepotDownloader.dll -app 359550 -depot 377238 -manifest 3175150742361965235 -username %username% %usecommand% -remember-password -dir "Downloads\Y5S4_NeonDawnHM" -validate -max-downloads %maxdownloads% -V
dotnet Resources\DepotDownloader.dll -app 359550 -depot 359551 -manifest 6947060999143280245 -username %username% %usecommand% -remember-password -dir "Downloads\Y5S4_NeonDawnHM" -validate -max-downloads %maxdownloads% -V
pause
...
cls
set /p username="Enter Steam Username:"
echo Please be aware this version does NOT support Heated Metal! Use the other Neon Dawn option if you wish to use Heated Metal.
echo Launch the game using the RainbowSix.bat file instead of the RainbowSix.exe^!
pause
...
echo.
Resources\cmdMenuSel f870 "  <- Back to Main Menu" "  Refresh menu" "  Wind Bastion TS  | Y3S4 | 20/10/18" "  Steel Wave TS    | Y5S2 | 02/06/20" "  Shadow Legacy TS | Y5S3 | 08/10/20" "  Ember Rise TS    | Y4S3 | 10/09/19" "  Crimson Heist TS | Y6S1 | 22/02/21" "  North Star TS    | Y6S2 | 25/05/21" "  Daybreak TS      | Y10S2| 28/05/25"
echo.
if %ERRORLEVEL% == 1 goto mainmenu
if %ERRORLEVEL% == 2 goto testservers
if %ERRORLEVEL% == 3 goto ts-y3s4
if %ERRORLEVEL% == 4 goto ts-y5s2
...
:ts-y3s4
MODE 120,20
Title Downloading Wind Bastion (20/10/18) Test Server...
cls
set /p username="Enter Steam Username:"
dotnet Resources\DepotDownloader.dll -app 623990 -depot 623991 -manifest 7643239543877220581 -username %username% %usecommand% -remember-password -dir "Downloads\Y3S4_WindBastion_ts20_10_18" -validate -max-downloads %maxdownloads% -V
pause
Robocopy Resources\Cracks\Y1SX-Y6S2 Downloads\Y3S4_WindBastion_ts20_10_18
goto downloadcomplete
...
cls
set /p username="Enter Steam Username:"
dotnet Resources\DepotDownloader.dll -app 623990 -depot 623991 -manifest 1268848856509013057 -username %username% %usecommand% -remember-password -dir "Downloads\Y5S2_SteelWave_ts02_06_20" -validate -max-downloads %maxdownloads% -V
pause
...
cls
set /p username="Enter Steam Username:"
dotnet Resources\DepotDownloader.dll -app 623990 -depot 623991 -manifest 8833805637802398440 -username %username% %usecommand% -remember-password -dir "Downloads\Y5S3_ShadowLegacy_ts08_10_20" -validate -max-downloads %maxdownloads% -V
pause
...
cls
set /p username="Enter Steam Username:"
dotnet Resources\DepotDownloader.dll -app 623990 -depot 623991 -manifest 8284402568137361637 -username %username% %usecommand% -remember-password -dir "Downloads\Y4S3_EmberRise_ts10_09_19" -validate -max-downloads %maxdownloads% -V
pause
...
cls
set /p username="Enter Steam Username:"
dotnet Resources\DepotDownloader.dll -app 623990 -depot 623991 -manifest 7921295012062018715 -username %username% %usecommand% -remember-password -dir "Downloads\Y6S1_CrimsonHeist_ts22_02_21" -validate -max-downloads %maxdownloads% -V
pause
...
cls
set /p username="Enter Steam Username:"
dotnet Resources\DepotDownloader.dll -app 623990 -depot 623991 -manifest 6881719580573646381 -username %username% %usecommand% -remember-password -dir "Downloads\Y6S2_NorthStar_ts25_05_21" -validate -max-downloads %maxdownloads% -V
pause
...
cls
set /p username="Enter Steam Username:"
dotnet Resources\DepotDownloader.dll -app 623990 -depot 623991 -manifest 5235883268902565724 -username %username% %usecommand% -remember-password -dir "Downloads\Y10S2_Daybreak_ts28_05_25" -validate -max-downloads %maxdownloads% -V
pause
...
echo ----------------------------------------------------------
echo.
Resources\cmdMenuSel f870 "  <- Back to Main Menu" "  Refresh Menu" "  Download Liberator (Y1S0 - Y4S4)" "  Download Liberator 2 (Y5S3)" "  Download DXVK" "  Download R6S Global"
if %ERRORLEVEL% == 1 goto mainmenu
